...
Hex,Opcode,Length,Cycles,After CB,Length,Cycles,After DDFDCB,Length,Cycles,After ED,Length,Cycles
00,NOP,1,4,RLC B,1,8,LD B, RLC (HL),1,0,,,
01,LD BC, ^,3,10,RLC C,1,8,LD C, RLC (HL),1,0,,,
02,LD BC, (A),1,7,RLC D,1,8,LD D, RLC (HL),1,0,,,
...
CB,<escape>,0,,SET 1, E,1,8,LD E, RES 1, (HL),1,0,,,
...
DD,<escape>,0,,SET 3, L,1,8,LD L, RES 3, (HL),1,0,,,
...
ED,<escape>,0,,SET 5, L,1,8,LD L, RES 5, (HL),1,0,,,
